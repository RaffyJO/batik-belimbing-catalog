<div class="container xl:max-w-6xl mx-auto px-4">
    ...
    <header class="text-center mx-auto mb-12 lg:px-20">
        <h2 class="text-2xl leading-normal mb-2 font-bold text-black">@lang('landing-page.activity.title')</h2>
        <p class="text-gray-800 leading-relaxed font-light text-xl mx-auto pb-2">@lang('landing-page.activity.description')</p>
    </header><!-- End heading -->
</div>
            ...
            <div class="relative overflow-hidden cursor-pointer mb-6">
                <a href="{{ Storage::url($activity->gambar) }}" alt="Kegiatan Batik Malang" data-gallery="gallery1"
                    ...
                    <img class="block w-full h-auto transform duration-500 hover:scale-125"
                        style="min-height: 200px; max-height: 200px; object-fit: cover; border-radius: 4px;"
